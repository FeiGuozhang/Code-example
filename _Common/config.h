...
/*----------------------------------------------------*/
	...
	#define Open207Z_USARTx_TX_PIN                 	GPIO_Pin_5
	#define Open207Z_USARTx_TX_GPIO_PORT           	GPIOD
	#define Open207Z_USARTx_TX_GPIO_CLK            	RCC_AHB1Periph_GPIOD
	#define Open207Z_USARTx_TX_SOURCE              	GPIO_PinSource5
	#define Open207Z_USARTx_TX_AF                  	GPIO_AF_USART2
	
	
	#define Open207Z_USARTx_RX_PIN                 	GPIO_Pin_6
	#define Open207Z_USARTx_RX_GPIO_PORT           	GPIOD
	#define Open207Z_USARTx_RX_GPIO_CLK            	RCC_AHB1Periph_GPIOD
	#define Open207Z_USARTx_RX_SOURCE              	GPIO_PinSource6
